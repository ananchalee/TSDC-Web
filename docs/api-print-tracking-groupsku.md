...
|---|---|---|---|
| `1` | Lex, Flash, ... | มีทั้งคู่ | ระบุขนาดกล่อง → **running** → พิมพ์ PDF จาก `FILE_PACKING` |
| `2` | DocP | ว่างทั้งคู่ | ระบุขนาดกล่อง → **running** → พิมพ์ใบ tracking running (html) |
...
หน้ารายงานนี้ไม่มีการสแกน → ไม่มีแถว `DETAIL_NEW` ที่ `REF_INDEX is null`
