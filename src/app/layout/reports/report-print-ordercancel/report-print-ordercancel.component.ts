...
@Component({
  selector: 'app-report-print-ordercancel',
  templateUrl: './report-print-ordercancel.component.html',
  styleUrls: ['./report-print-ordercancel.component.scss']
})
export class ReportPrintOrderCancelComponent implements OnInit {
