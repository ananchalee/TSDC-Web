...
@Component({
  selector: 'app-moniter-InterfaceErrorManH',
  templateUrl: './moniter-InterfaceErrorManH.component.html',
  styleUrls: ['./moniter-InterfaceErrorManH.component.scss']
})
export class MoniterInterfaceErrorManHComponent implements OnInit {
